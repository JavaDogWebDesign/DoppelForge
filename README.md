...
If you find a way to make real data leave the tab, please report it privately — email `security@doppelforge.com` and see [SECURITY.md](./SECURITY.md) for the full policy.
